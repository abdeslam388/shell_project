...
/**
 * get_env - give the value of gllobal variable
 * @glob_v: glob_value of the global varr
 * Return: string
 */
...
/**
 * concatenat - conccats three strings in new allocation memo
 * @glob_v: first string input
 * @valeur1: secoond string input
 * @valeur: Thiird string input
 * Return: pointerr to the new string
 */
...
/**
 * _setenv - Initialize a new envr
 * @arr: array of print wordss
 */
